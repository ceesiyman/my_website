...
<html>
	<head>
		...
		<link href="lnon.css" rel="stylesheet" type="text/css">
...
$sql = "SELECT * FROM nonacademic";  //Writing query for all the students 
...
<html> 
	<head> 
		...
		<link rel="stylesheet" href="lnon.css" type="text/css" />
		<style>
			th{
    font-size: 25px;
}
td{
	...
	<body> 
		...
		<thead>
		<tr> 
		<th colspan="8"><h3>Non Academic SBooks Data</h3></th> 
		</tr> 
		<tr>
			<th> TITLE </th> 
			<th> AUTHOR </th> 
